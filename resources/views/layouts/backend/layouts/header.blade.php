		...
		<div class="d-flex">
			...
			<div class="navbar-brand-box">
				...
				<a href="{{ route('admin.dashboard') }}" class="logo logo-light">
					<span class="logo-sm">
						<img src="{{ asset('backend') }}/assets/images/favicon_1.png" alt="" height="40">
					</span>
					<span class="logo-lg">
						<img src="{{ asset('backend') }}/assets/images/logo.png" alt="" width="130" height="60">
					</span>
				</a>
			</div>
		...
		<div class="d-flex">
			...
			<div class="dropdown d-inline-block">
				...
				<div class="dropdown-menu dropdown-menu-end">
					<a class="dropdown-item" href="javascript:void(0)"><span key="t-profile">Welcome {{ Auth::user()->name }}</span></a>
