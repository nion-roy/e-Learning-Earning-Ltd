								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="text" name="branch_name" class="form-control @error('branch_name') is-invalid @enderror" id="branch_name" placeholder="Enter branch name" value="{{ old('branch_name') }}">
											@error('branch_name')
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="number" name="contact_1" class="form-control @error('contact_1') is-invalid @enderror" id="contact_1" placeholder="Enter contact number" value="{{ old('contact_1') }}">
											@error('contact_1')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="number" name="contact_2" class="form-control @error('contact_2') is-invalid @enderror" id="contact_2" placeholder="Enter contact number" value="{{ old('contact_2') }}">
											@error('contact_2')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="email" name="email_1" class="form-control @error('email_1') is-invalid @enderror" id="email_1" placeholder="Enter email" value="{{ old('email_1') }}">
											@error('email_1')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="email" name="email_2" class="form-control @error('email_2') is-invalid @enderror" id="email_2" placeholder="Enter email" value="{{ old('email_2') }}">
											@error('email_2')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
