...
@section('main_content')
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title mb-4">New Partner Create</h4>

					<form action="{{ route('admin.all-partners.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group mb-3">
											...
											<input type="text" name="partner_name" class="form-control @error('partner_name') is-invalid @enderror" id="partner_name" placeholder="Enter partner name" value="{{ old('partner_name') }}">
											@error('partner_name')
												<div class="text-danger">{{ $message }}</div>
											@enderror
										</div>
